...
export const SCREEN_PRESETS = {
  ...
  '1080p': { width: 1920, height: 1080, frameRate: 30, maxBitrate: 5_000_000, label: '1080p · 30fps' },
  '1080p60': { width: 1920, height: 1080, frameRate: 60, maxBitrate: 8_000_000, label: '1080p · 60fps' },
  '1440p': { width: 2560, height: 1440, frameRate: 30, maxBitrate: 10_000_000, label: '1440p · 30fps (2K)' },
  '1440p60': { width: 2560, height: 1440, frameRate: 60, maxBitrate: 16_000_000, label: '1440p · 60fps (2K)' },
};
...
export function canShareScreen(): boolean {
  ...
  const md = navigator.mediaDevices as unknown as { getDisplayMedia?: unknown } | undefined;
