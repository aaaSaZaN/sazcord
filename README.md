...
#### Шаг 7: Первый вход
1. Откройте `https://sazcord.example.com` в браузере.
2. Первый зарегистрированный пользователь **автоматически становится администратором (`id=1`)**.
3. После этого регистрация автоматически закрывается, выдавать доступы новым пользователям можно через инвайт-ссылки в панели настроек.
...
| `REGISTRATION_OPEN` | `0` | `1` - сделать регистрацию полностью открытой для всех. |
| `REGISTRATION_DISABLED`| `0` | `1` - закрыть регистрацию даже при наличии кодов. |
